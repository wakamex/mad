...
- emit an offline report for tick order, reveal timing, precursor-distance diagnostics, simple score baselines, and random-play audits (`mean`, `p90`, `p99`, positive-rate)
